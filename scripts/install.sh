...
echo ""
echo "Day-to-day commands (every call is worktree-correct — see 'relay where'):"
echo "  relay task list --status open  # what's ready to pick up"
echo "  relay task create --title \"…\"  # new task"
echo "  relay plan cut-tasks PLAN-001  # checkboxes → linked tasks"
echo "  relay --help                   # full CLI surface"
echo ""
